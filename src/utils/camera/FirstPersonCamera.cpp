...
void FirstPersonCamera::resetPos()
{
...
void FirstPersonCamera::key_callback(GLFWwindow* window, int key, int action)
{
...
void FirstPersonCamera::mouse_callback(double xpos, double ypos)
{
	if (m_InUse)
	{
...
bool FirstPersonCamera::handleWindowInput(GLFWwindow* window)
{
	currtime = glfwGetTime();
